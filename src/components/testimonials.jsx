...
const testimonials = () => {
  return (
    <motion.div 
        ...
        viewport={{once: true}}
    className='container mx-auto p-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='testimonials'>
        ...
        <p className='text-center text-gray-500 max-w-80 mb-8 mx-auto'>Real Stories from Those who found home With Us</p>
